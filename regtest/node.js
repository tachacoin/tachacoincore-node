...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.tachacoind.height === 150) {
            node.services.tachacoind.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.tachacoind.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('tachacoind/hashblock', function(data) {
        bus.unsubscribe('tachacoind/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.tachacoind.height;
      node.services.tachacoind.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.tachacoind.sendTransaction(tx.serialize(), function(err, hash) {
