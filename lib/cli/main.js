...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `tachacoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ tachacoincore-node add wallet-service');
      console.log('    $ tachacoincore-node add insight-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ tachacoincore-node remove wallet-service');
      console.log('    $ tachacoincore-node remove insight-api');
      console.log();
    });
